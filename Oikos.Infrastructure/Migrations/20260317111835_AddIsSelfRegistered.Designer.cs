...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260317111835_AddIsSelfRegistered")]
    partial class AddIsSelfRegistered
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.CompanyCheck.CompanyCheckRequest", b =>
                {
                    ...
                    b.Property<string>("SearchReason")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasComment("Business purpose for the company search");
                    ...
                    b.Property<string>("StripePaymentDataJson")
                        .HasColumnType("TEXT")
                        .HasComment("Complete Stripe payment details as JSON");
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Invoice.InvoiceClientDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("InvoiceId")
                        .HasColumnType("INTEGER")
                        .HasComment("Invoice this document belongs to");

                    b.Property<DateTime>("UploadedAt")
                        .HasColumnType("TEXT")
                        .HasComment("Upload time");

                    b.Property<int>("UploadedByUserId")
                        .HasColumnType("INTEGER")
                        .HasComment("User who uploaded this document");

                    b.HasKey("Id");

                    b.HasIndex("InvoiceId");

                    b.ToTable("InvoiceClientDocuments", t =>
                        {
                            t.HasComment("Documents uploaded by the client for a specific invoice");
                        });
                });
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Invoice.InvoiceStage", b =>
                {
                    ...
                    b.Property<string>("ClientName")
                        .HasMaxLength(150)
                        .HasColumnType("TEXT")
                        .HasComment("Client-facing stage name (English)");

                    b.Property<string>("ClientNameDe")
                        .HasMaxLength(150)
                        .HasColumnType("TEXT")
                        .HasComment("Client-facing stage name (German)");
                    ...
                    b.Property<bool>("RequiresClientAction")
                        .HasColumnType("INTEGER")
                        .HasComment("When true, the client must take an action (e.g. commission enforcement) to advance the case");
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Partner.Partner", b =>
                {
                    ...
                    b.Property<string>("Address")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT")
                        .HasComment("Business address");

                    b.Property<string>("BusinessName")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT")
                        .HasComment("Official business/company name");
                    ...
                    b.Property<int?>("CommissionPeriodMonths")
                        .HasColumnType("INTEGER")
                        .HasComment("Months commissions are paid after membership start (null = unlimited)");

                    b.Property<decimal?>("CommissionRate")
                        .HasColumnType("TEXT")
                        .HasComment("Commission rate as a percentage");

                    b.Property<string>("CommissionType")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasComment("Commission type: Monthly, Yearly, OneTime");
                    ...
                    b.Property<string>("ContactPerson")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT")
                        .HasComment("Name of the contact person at the partner");
                    ...
                    b.Property<bool>("IsActive")
                        .HasColumnType("INTEGER")
                        .HasComment("Whether the partner is active");
                    ...
                    b.Property<int?>("ParentPartnerId")
                        .HasColumnType("INTEGER")
                        .HasComment("Parent partner id for sub-partners");

                    b.Property<string>("PartnerType")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasComment("Partner type: Rechtsanwalt, Steuerberater, Notar, Unternehmensberater, Sonstige");
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Rbac.User", b =>
                {
                    ...
                    b.Property<bool>("IsSelfRegistered")
                        .HasColumnType("INTEGER")
                        .HasComment("True when the user registered themselves via the public registration page");
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Rbac.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<string>("Permission")
                        .IsRequired()
                        .HasColumnType("TEXT")
                        .HasComment("Permission key (see EmployeePermissions constants)");
                    ...
                    b.ToTable("UserPermissions", t =>
                        {
                            t.HasComment("Employee permission entry");
                        });
                });
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Subscription.UserSubscription", b =>
                {
                    ...
                    b.Property<string>("PaymentMethod")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasComment("Payment method: Stripe, SEPA, Manuell, etc.");
                    ...
                    b.Property<int?>("SubscriptionId")
                        .HasColumnType("INTEGER")
                        .HasComment("Foreign key to the purchase record");
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.TaxOffice.TaxOffice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<string>("Code")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasComment("Unique referral code (STB-xxxx format)");

                    b.Property<string>("ContactPerson")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT")
                        .HasComment("Name of the contact person");
                    ...
                    b.Property<bool>("IsActive")
                        .HasColumnType("INTEGER")
                        .HasComment("Whether the tax office is active");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("TEXT")
                        .HasComment("Tax office display name");
                    ...
                    b.ToTable("TaxOffices", t =>
                        {
                            t.HasComment("Tax offices / Steuerberaterbüros");
                        });
                });
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Partner.Partner", b =>
                {
                    b.HasOne("Oikos.Domain.Entities.Partner.Partner", "ParentPartner")
                        .WithMany("SubPartners")
            ...
            modelBuilder.Entity("Oikos.Domain.Entities.Subscription.UserSubscription", b =>
                {
                    b.HasOne("Oikos.Domain.Entities.Subscription.Subscription", "Subscription")
                        .WithMany()
