...
public partial class User
{
    ...
    // private List<RoleDto> _roleList = new(); // No longer needed for Admin view as we filter by Admin only
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        var adminRole = rolesResult.Items.FirstOrDefault(r => r.Name == RoleNames.Admin.ToRoleName());
        if (adminRole != null)
        {
    ...
    private async Task LoadUsersAsync()
    {
        ...
        var criteria = new UserSearchCriteria
        {
            ...
            RoleId = _adminRoleId, // Force filter by Admin role
